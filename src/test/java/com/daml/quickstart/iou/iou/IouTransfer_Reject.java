...
public class IouTransfer_Reject extends DamlRecord<IouTransfer_Reject> {
  public static final String _packageId = "407382e4ffc06fed9636591a1196d8ce97961b51b1398fb9da5db679ec6e45fc";

  public IouTransfer_Reject() {
  }

  /**
   * @deprecated since Daml 2.5.0; use {@code valueDecoder} instead */
  @Deprecated
  public static IouTransfer_Reject fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<IouTransfer_Reject> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof IouTransfer_Reject)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "com.daml.quickstart.iou.iou.IouTransfer_Reject";
  }
}
